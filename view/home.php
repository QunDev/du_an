                            ...
                            <div class="filter__row filter__content">
                                ...
                                <div class="filter__col">
                                    ...
                                    <div class="filter__form-group filter__form-group--inline">
                                        <div>
                                            <label for="" class="form__label form__label--small"> Tối Thiểu  </label>
                                        ...
                                        <div>
                                            <label for="" class="form__label form__label--small"> Tối đa </label>
                                            <div class="filter__form-text-input filter__form-text-input--small">
                                                <input type="text" name="" id="" class="filter__form-input"
                                                    value="$100.00" />
                                            </div>
                                ...
                                <!-- Filter column 2 -->
                                <div class="filter__col">
                                    <label for="" class="form__label">Kích thước / Trọng lượng </label>
                                    <div class="filter__form-group">
                                    ...
                                    <div class="filter__form-group">
                                        <div class="form__tags">
                                            ...
                                            <button class="form__tag">Bình thường</button>
                                            <button class="form__tag">To</button>
                                        </div>
                                    </div>
                                </div>
