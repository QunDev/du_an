...
// Update data product by id
    function updateProductById() {
        $sql = "UPDATE `products` SET `productID`='[value-1]',`productName`='[value-2]',`description`='[value-3]',`price`='[value-4]',`stock`='[value-5]',`brand`='[value-6]',`imageURL`='[value-7]',`createdAt`='[value-8]' WHERE 1"
    }
?>