<div class="flex">
    ...
    <div class="form-group">
      <label for="nameProduct" class="form-label">Name Product Old</label>
      <input
        id="nameProduct"
        name="nameProduct"
        type="text"
        placeholder="VD: The Burger Cafe"
        class="form-control"
    ...
    <div class="form-group">
      ...
      <textarea name="desc" id="desc" cols="30" rows="10" placeholder="<?php echo $desc ?>" readonly></textarea>
      <span class="form-message"></span>
    </div>
    ...
    <div class="form-group">
      ...
      <select name="idCategory" id="idCategory">
        <option value="<?php echo $idCategory ?>" selected hidden>
        <?php
    ...
    <div class="form-group">
    <label for="imgProduct" class="form-label">Img</label>
      <?php echo $image ?>
    </div>
